        ...
        <div>
            <div className="privacy-policy-page">
                <div className="privacy-policy-header">
                    ...
                    <p className="effective-date">Effective Date: August 25, 2016</p>
                    <p>
                        This Privacy Policy describes how we collect, use, store, process,
                        and share your information in relation to our website. Please review
                        this Policy carefully before using our site.
                    </p>
                    <p>
                        Global Academy Public School (“GAPS,” “we,” “us,” or “our”) understands the importance of your privacy. This Privacy Policy (“Policy”) describes how we collect, use, store, process, and share your information in relation to https://www.gapsweb.com (the “Site”). Please review this Policy carefully before using our Site. By accessing, browsing, or using the Site, you consent to the terms described in this Policy.

                        This Policy applies only to the online activities of GAPS through the Site. It does not apply to information collected, used, or disclosed in any other way, including, for example, information collected offline or by third parties that may be accessible from or link to the Site.

                        Public records requests, access to education records, and collection and maintenance of student information by other means are governed by state and central laws, including, but not limited to, applicable state laws.
                    </p>
                </div>
                ...
                <div className="privacy-policy-section">
                    ...
                    <p>
                        We reserve the right to revise this Policy from time to time by updating it and posting it at https://www.gapsweb.com/privacy-policy with the new terms taking effect on the date of posting. You should periodically review this Policy to ensure you are familiar with the most current version. Your use of the Site after the Effective Date posted above constitutes your acceptance of the updated Policy.
                    </p>
                </div>
                ...
                <div className="privacy-policy-section">
                    ...
                    <p>
                        ...
                        In order to participate in certain functionalities, you may be asked to provide personally identifiable information, including, but not limited to:
                        ...
                        Third Party Analytics Providers. We use third parties to help us operate and improve the Site. In doing so, we may share with these third parties and they may collect from you non-personally identifiable information about your use of the Site. These third party providers may also use cookies. For example, we use third party analytics providers, such as Google Analytics, to provide us with general demographic and interest-level information about our users and to help create a better user experience. For more information regarding Google’s use of cookies and collection and use of information see the Google Privacy Policy. To opt out of Google Analytics, please visit the Google Analytics Opt-Out Page to learn about opting out and installing the appropriate browser add-on. We do not control information collected by third parties and are not responsible for their use of that information.
                ...
                <div className="privacy-policy-section">
                    <h2>Accessing, Updating, or Deleting your Personal Information</h2>
                    <p>
                ...
                <div className="privacy-policy-section">
                    <h2>Contact Information and Privacy Questions</h2>
                    <p>
                        If you have questions about this Policy or other matters that relate to it, you may contact us at: ghfs.paonta@gmail.com.
                    </p>
                </div>
            </div>
            <Footer/>
